...
export default function Panel({headerTitle, headerRenderer, height, flex, children, ...props}) {
    const HeaderRenderer = headerRenderer;
    return <Vertical height={height} color={"light"} brightness={0} bB={3} flex={flex}>
